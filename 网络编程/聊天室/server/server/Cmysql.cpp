...
bool Cmysql::LinkDataBase1(string server,
	string DbName,
	string UserName,
	string PassWord)
{
...
bool Cmysql::ExeSqlByConnect(_RESULT &re, string sql)
{
	try
	{
...
bool Cmysql::ExeSqlByCommand(_RESULT &re, string sql)
{
	try
	{
		_CommandPtr pComm;
...
bool Cmysql::ExeSqlByRecordSet(_RESULT &re, string sql)
{
	try
	{
...
bool Cmysql::ParseRecordSet(_RESULT &re, _RecordsetPtr pReCordset)
{
	try
	{
		//1. 取列名
