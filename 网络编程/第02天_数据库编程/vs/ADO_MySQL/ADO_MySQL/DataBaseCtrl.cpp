...
bool CDataBaseCtrl::LinkDataBase(string server, 
								string DbName, 
								string UserName, 
								string PassWord)
{
...
bool CDataBaseCtrl::ExeSqlByConnect(_RESULT &re, string sql)
{
	try
	{
...
bool CDataBaseCtrl::ExeSqlByCommand(_RESULT &re, string sql)
{
	try
	{
		_CommandPtr pComm;
...
bool CDataBaseCtrl::ExeSqlByRecordSet(_RESULT &re, string sql)
{
	try
	{
...
bool CDataBaseCtrl::ParseRecordSet(_RESULT &re, _RecordsetPtr pReCordset)
{
	try
	{
		//1. 取列名
