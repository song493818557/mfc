...
int check_helpa = 0;
int Max_play = 0;//当前游戏最大玩家数
int Goto = 0;//去地图编辑还是去坦克大战
int Tank_life = 5;//我方坦克生命值
int Max_Rebottank = 2;//机器人坦克
int max_kill = 10;//最大击杀数
int now_max_kill = 0;//最大击杀数
int in_map = 2;//当前地图
int check_Rebottank = 0;//初始化当前活着的我方坦克数量
int check_play = 0;//初始化当前活着的我方坦克数量
...
void Cmenu::main_menu(int a){
	Goto = 88; in_map = 2;  Max_play = 1;  return;
	system("cls");
	system("color 0f");
	m_menu_state = a;
	switch (m_menu_state)
