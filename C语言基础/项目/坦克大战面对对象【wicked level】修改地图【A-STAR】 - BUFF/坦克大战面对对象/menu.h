...
extern int   check_helpa;
extern int   Max_play;//当前
extern int   Goto;//去地图
extern int   Tank_life;//我
extern int   Max_Rebottank;
extern int   max_kill;//最大
extern int   now_max_kill;  
extern int   in_map;//当前地
extern int   check_Rebottank;
extern int   check_play;//初
extern int  now_map[40][40]; 