...
void Ceditmap::Savemap(){
	...
	switch (in_map)
	{
	case 0:fopen_s(&pFile, "0.txt", "rb+"); break;//默认地图
	case 1:fopen_s(&pFile, "1.txt", "rb+"); break;//存档地图
	case 2:fopen_s(&pFile, "2.txt", "rb+"); break;//关卡一
	case 3:fopen_s(&pFile, "3.txt", "rb+"); break;//关卡二
	case 4:fopen_s(&pFile, "4.txt", "rb+"); break;//关卡三
	}
	fwrite(
		now_map, //写的起始地址 buf2
		4, //一块的大小
